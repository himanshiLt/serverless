...
class AwsCompileFunctions {
  ...
  async compileFunction(functionName) {
    ...
    const console = this.serverless.console;
    if (console.isEnabled && console.isFunctionSupported(functionObject)) {
      if (!functionResource.Properties.Environment) functionResource.Properties.Environment = {};
      if (!functionResource.Properties.Environment.Variables) {
        functionResource.Properties.Environment.Variables = {};
      }
      if (!functionResource.Properties.Layers) functionResource.Properties.Layers = [];

      Object.assign(
        functionResource.Properties.Environment.Variables,
        await console.deferredFunctionEnvironmentVariables
      );
