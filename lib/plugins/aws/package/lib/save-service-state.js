...
module.exports = {
  async saveServiceState() {
    ...
    if (this.serverless.console.isEnabled) {
      state.console = {
        otelIngestionToken: await this.serverless.console.deferredOtelIngestionToken,
        extensionLayerVersionPostfix: this.serverless.console.extensionLayerVersionPostfix,
      };
    }
