        ...
        (async () => {
          try {
            await this.provider.request('S3', 'headObject', {
              Bucket: this.bucketName,
              Key: `${this.serverless.service.package.artifactsS3KeyDirname}/${this.console.extensionLayerFilename}`,
            });
            ...
            await limitedUpload({
              filename: path.join(this.packagePath, this.console.extensionLayerFilename),
